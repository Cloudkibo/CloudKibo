function IMController ($scope, socket, $http, $timeout){
...
function HomeController ($scope, $http, socket, pc_config, pc_constraints, sdpConstraints, $timeout){
	...
	$http.get('/getContactsList').success(function(data){ 
		console.log(data)
	...
	$http.get('/getAddRequestsList').success(function(data){ 
    	$scope.addRequestslist = data.msg;
    });
	
	$scope.addUserName = function() {
		$http.post('/addUserName', JSON.stringify($scope.add))
		.success(function(data) {
			if(data.status == 'success'){
				if(data.msg != null){
					$scope.userFound = data.msg;
	...
	$scope.addEmail = function() {
		$http.post('/addEmail', JSON.stringify($scope.add))
		.success(function(data) {
			if(data.status == 'success'){
				if(data.msg != null){
					$scope.userFound = data.msg;
	...
	$scope.approveFriendRequest = function(index){
		$http.post('/approveFriendRequest', $scope.addRequestslist[index].userid)
		.success(function(data){
			if(data.status == 'success'){
				$scope.contactslist = data.msg;
	...
	$scope.rejectFriendRequest = function(index){
		$http.post('/rejectFriendRequest', $scope.addRequestslist[index].userid)
		.success(function(data){
			if(data.status == 'success'){
				$scope.addRequestslist.splice(index, 1);
			}
	 ...
	 $scope.setStatus = function (){
		 ...
		 if($scope.user.status != null){
			 if($scope.user.status.trim() != ''){
				 ...
				 $http.post('/setStatusStatement', $scope.user).success(function(data){});
			 }
		 }
...
function AddRequestsController ($scope){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LIVE HELP ROOM CONTROLLER                                                                                 //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////


function LiveHelpController ($scope, $http, socket, pc_config, pc_constraints, sdpConstraints, $timeout){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// OTHER PARTIAL VIEW CONTROLLERS                                                                               //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////

function WelcomeScreenController ($scope){}

function UserViewController ($scope){}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// FOR ANDROID TEST VIDEO CALL                                                                               //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////


function VideoCallController ($scope, $http, socket, pc_config, pc_constraints, sdpConstraints, $timeout){
